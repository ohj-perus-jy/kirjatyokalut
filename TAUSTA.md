# Tausta: koeputken README

Tämä on ohj1:n `zensical/README.md` sellaisena kuin se oli, kun työkalut
siirrettiin tähän repoon (ohj1 `rakenne-2027`, 39316cf). Se kertoo, mitä
